...
// —— AJOUT mots “Examens” FR → RU ——
Object.assign(FR_RU, {
  "lis": ["читать"], "lire": ["читать"],
  "attentivement": ["внимательно"],
  "texte": ["текст"],
  "suivant": ["следующий"],
  "réponds": ["отвечать"], "répondre": ["отвечать"],
  "aux": ["к (предлог + артикль)"],
  "questions": ["вопросы"],
  "expliquez": ["объяснять"], "expliquer": ["объяснять"],
  "avec": ["с"],
  "vos": ["ваши"],
  "propres": ["собственные"],
  "justifiez": ["обосновывать"], "justifier": ["обосновывать"],
  "donnez": ["дать"], "donner": ["дать"],
  "un": ["один (артикль, часто не переводится)"],
  "précis": ["точный", "конкретный"],
  "citez": ["цитировать", "приводить"], "citer": ["цитировать", "приводить"],
  "deux": ["два"],
  "arguments": ["аргументы"], "argument": ["аргумент"],
  "du": ["из / от (родительный падеж)"],
  "passage": ["отрывок"],
  "quelques": ["несколько"],
  "lignes": ["строки"], "ligne": ["строка"],
  "quelle": ["какой / какая"],
  "principale": ["главная"],
  "dégagez": ["выявить"], "dégager": ["выявить"],
  "problématique": ["проблематика", "проблема"],
  "sujet": ["тема"],
  "montrez": ["показать"], "montrer": ["показать"],
  "en": ["в", "из"],
  "quoi": ["что", "в чём"],
  "actuel": ["актуальный"],
  "conclusion": ["вывод"],
  "peut": ["может"],
  "tirer": ["вытянуть", "сделать (вывод)"],
  "avis": ["мнение"],
  "solution": ["решение"],
  "développez": ["развивать"], "développer": ["развивать"],
  "opinion": ["мнение"],
  "dix": ["десять"],
  "comparez": ["сравнить"], "comparer": ["сравнить"],
  "relevez": ["отметить"], "relever": ["отметить"],
  "différences": ["различия"], "différence": ["различие"],
  "ressemblances": ["сходства"], "ressemblance": ["сходство"],
  "analysez": ["проанализировать"], "analyser": ["проанализировать"],
  "structure": ["структура"],
  "décrivez": ["описать"], "décrire": ["описать"],
  "scène": ["сцена"],
  "représentée": ["представленная"],
  "interprétez": ["интерпретировать"], "interpréter": ["интерпретировать"],
  "comportement": ["поведение"],
  "personnage": ["персонаж"],
  "causes": ["причины"], "cause": ["причина"],
  "conséquences": ["последствия"], "conséquence": ["последствие"],
  "avantages": ["преимущества"], "avantage": ["преимущество"],
  "inconvénients": ["недостатки"], "inconvénient": ["недостаток"],
  "utilise": ["использует"], "utiliser": ["использовать"],
  "synonyme": ["синоним"],
  "terme": ["термин"],
  "souligné": ["подчеркнутый"],
  "antonyme": ["антоним"],
  "remplacez": ["замените"], "remplacer": ["заменить"],
  "autre": ["другой"],
  "sens": ["смысл"],
  "conjuguez": ["спрягать"], "conjuguer": ["спрягать"],
  "verbe": ["глагол"],
  "demandé": ["требуемый"],
  "transformez": ["преобразовать"], "transformer": ["преобразовать"],
  "forme": ["форма"],
  "négative": ["отрицательная"],
  "pluriel": ["множественное число"],
  "interrogative": ["вопросительная"],
  "écrivez": ["напишите"], "écrire": ["написать"],
  "lettre": ["письмо"],
  "officielle": ["официальное"],
  "courrier électronique": ["электронное письмо"],
  "dialogue": ["диалог"],
  ...
  "identifiez": ["определите"], "identifier": ["определить"],
  "registre": ["стиль", "регистр"],
  "point de vue": ["точка зрения"],
  "paragraphe": ["абзац"],
  "argumenté": ["аргументированный"],
  "plan": ["план"],
  "détaillé": ["подробный"],
  "morale": ["мораль"],
  "histoire": ["история"],
  ...
  "fonction": ["функция"],
  "principal": ["главный"],
  "figure de style": ["фигура речи"],
  "employée": ["используемая"],
  "métaphore": ["метафора"],
  "hyperbole": ["гипербола"],
  "champ lexical": ["лексическое поле"],
  "dominant": ["доминирующий"],
  "adjectifs qualificatifs": ["качественные прилагательные"],
  "verbes conjugués": ["спряжённые глаголы"],
  "compléments d’objet direct": ["прямые дополнения"],
  "ordre": ["порядок"],
  "correct": ["правильный"],
  "complétez": ["дополните"], "compléter": ["дополнить"],
  "proposés": ["предложенные"],
  "choisissez": ["выберите"], "choisir": ["выбрать"],
  "bonne": ["хороший / правильный"],
  "propositions": ["варианты", "предложения"],
  "cochez": ["отметьте галочкой"], "cocher": ["отметить галочкой"],
  "case": ["клетка", "окошко"],
  "correcte": ["правильная"],
  "reliez": ["соедините"], "relier": ["соединить"],
  "colonnes": ["колонки"], "colonne": ["колонка"],
  "classez": ["классифицируйте", "распределите"], "classer": ["классифицировать"],
  "manquant": ["отсутствующий"],
  "réécrivez": ["перепишите"], "réécrire": ["переписать"],
  "faute": ["ошибка"],
  "corrigez": ["исправьте"], "corriger": ["исправить"],
  "erreurs": ["ошибки"], "erreur": ["ошибка"],
  ...
  "pense": ["думаю"],
  "que": ["что"],
  "argumentez": ["аргументируйте"], "argumenter": ["аргументировать"],
  "parties": ["части"], "partie": ["часть"],
  "concluez": ["заключите", "подведите итог"], "conclure": ["заключить"],
  "ouverture": ["открытие", "расширение"],
});
