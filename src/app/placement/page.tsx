...
import P_EN from "@/content/placement_en";
import P_FR from "@/content/placement_fr";
...
export default function PlacementPage() {
  ...
  const items = course === "en" ? P_EN : P_FR;
  ...
  function finish() {
    ...
    updateProfile({ ...profile, cefr });   // on note le niveau estimé
  ...
  return (
    <main className="max-w-2xl mx-auto p-6 space-y-4">
      ...
      <p className="text-sm text-gray-600">12 phrases, sans aide. Appuie sur Entrée pour valider.</p>
